...
const OPEN_COMING_SOON_MODAL = 'modal/OPEN_COMING_SOON_MODAL';
...
export const open_coming_soon_modal = () => { return { type: OPEN_COMING_SOON_MODAL } }
...
const UIreducer = (prevstate = { modal: null, dropdown: false }, action) => {
    ...
    switch (action.type) {
        ...
        case OPEN_COMING_SOON_MODAL:
            return { modal: "open_coming_soon_modal"}
